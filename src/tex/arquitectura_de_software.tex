...
Esta coordinación se realiza a través de un \textbf{Message-Oriented Middleware (MOM)}, centralizado y basado en un modelo de colas asíncronas de mensajes. En este esquema, cada cola representa una operación específica a ejecutar, como select, project, sort, group by o join.