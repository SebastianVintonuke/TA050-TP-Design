...
Esta coordinación se realiza a través de un \textbf{Message-Oriented Middleware (MOM)}, centralizado y basado en un modelo de colas asíncronas de mensajes. En este esquema, cada nodo tiene una cola de entrada y despacha sus resultados a una siguiente cola, al finalizar, se consolidan los resultados y se envían al almacenamiento persistente.