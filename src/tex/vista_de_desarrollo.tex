...
\textbf{State Storage}: Almacenamiento persistente para partes del sistema con estado. Garantiza que los datos parciales se conserven en caso de falla.

\textbf{Result Storage}: Repositorio persistente para almacenar los resultados finales, asociados a clientes mediante el client\_id.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{img/vista_de_desarrollo/paquetes.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{img/vista_de_desarrollo/paquetes_protocolo.pdf}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.35\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/vista_de_desarrollo/paquetes_models.pdf}
        \caption{Paquete de modelos}
    \end{minipage}
    \hspace*{\fill}
    \begin{minipage}[b]{0.35\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/vista_de_desarrollo/paquetes_results.pdf}
